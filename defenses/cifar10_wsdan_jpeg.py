...
parser.add_argument('--data', default='../../data/cifar10/jpeg', help='path to dataset')
parser.add_argument('--workers', default=2, type=int, help='number of data loading workers')
parser.add_argument('--cpu', action='store_true', help='force training on cpu')
parser.add_argument('--save-folder', '--sf', default='weights/cifar10_wsgan_jpeg4_epoch10/', help='folder to save state dicts')
...
parser.add_argument('--visdom-env', '--ve', type=str, default="cifar10_wsgan_jpeg4_epoch10",
...
print("prepareData(args.data)", prepareData(args.data))
train_loader = prepareData(args.data)[
    'train_data']  # data.Subset(CIFAR10(args.data, train=True, transform=train_transform, download=True), list(range(45000)))
val_loader = prepareData(args.data)[
    'val_data']  # data.Subset(CIFAR10(args.data, train=True, transform=test_transform, download=True),
# list(range(45000, 50000)))
test_loader = load_data_for_defense(
    'dev_data')  # CIFAR10(args.data, train=False, transform=test_transform, download=True)
...
model_file = './weights/cifar10_WSDAN_smooth3/cifar10_valacc0.8644999772310257.pth'
cifar10_WSDAN_best = './weights/cifar10_WSDAN_best/cifar10_valacc0.8784999758005142.pth'
